...
/*
Ovo ispod možda i ne treba; možda je dovoljno android.database
Odnosi se na SQLException
import java.sql.*;
*/
...
public class BiljeskeDbAdapter {
    ...
    //private static final String TAG = "BiljeskeDbAdapter";
    private DatabaseHelper mDbHelper;
    private SQLiteDatabase mDb;
    
    // U New Bostonu (HotOrNot) cijeli ovaj tekst je ispisao unutar funkcije onCreate
    // Ovdje treba paziiti na nazive "notes, _id. title...."
    /* Moglo bi i ovako nešto
